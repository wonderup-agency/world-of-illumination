...
- `src/styles/locations.css` — overflow visible on swiper, scale/opacity transitions, and the "can't navigate" dimmed arrow state described above (see Notes for why it needs `!important`)
